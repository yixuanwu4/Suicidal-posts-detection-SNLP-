...
if __name__ == "__main__":
    ...
    accuracy = accuracy_score(new_vec_test_y,y_changed)
    precision = precision_score(new_vec_test_y,y_changed)
    recall = recall_score(new_vec_test_y,y_changed)
    f1 = f1_score(new_vec_test_y,y_changed)
